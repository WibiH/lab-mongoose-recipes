...
mongoose
  ...
  .then(() => {
    ...
    return Recipe.create({
      ...
      ingredients: [
        "50 g granulated soy",
        "1/4 tsp salt, 15 g dried shitake",
        "400 g silken tofu",
      ...
      cuisine: "Chinese from Szechuan province",
      dishType: "main_course",
      image:
        "https://www.eat-this.org/wp-content/uploads/2019/10/veganer_mapo-tofu-9-960x1440.jpg",
      duration: 30,
      creator: "Jörg from www.eat-this.org",
    }).then(() => {
  ...
  .then(() => {
    return Recipe.findOneAndUpdate({ duration: "220" }, { new: "100" });
  })
  .then(() => {
